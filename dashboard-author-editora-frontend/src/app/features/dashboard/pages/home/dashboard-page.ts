...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-[color:var(--bg)] px-4 md:px-8 py-6 space-y-6">
      <!-- Header -->
      <div class="flex items-center justify-between gap-4">
        <h1 class="text-2xl md:text-3xl font-bold text-[color:var(--ink-1)]">Painel do Autor</h1>
        ...
        <div class="flex items-center gap-2">
          ...
          <!-- Sininho (envólucro pra aumentar sem mexer no componente) -->
      ...
      <div class="grid gap-4 md:grid-cols-4 items-stretch">
        <app-kpi-card title="Receita (Mês)" kpiKey="revenue"></app-kpi-card>
        <app-kpi-card title="Pedidos" kpiKey="orders"></app-kpi-card>
        <app-kpi-card title="Cancelados" kpiKey="canceled"></app-kpi-card>
      ...
      <div class="flex justify-center items-center gap-12">
        ...
        <div>
          <div class="grid gap-6 md:grid-cols-2">
            <app-sales-funil [blockMinHeight]="360" [chartMaxHeight]="260"></app-sales-funil>
            <app-payment-methods
              [blockMinHeight]="360"
              [chartMaxHeight]="260"
            ></app-payment-methods>
      ...
      <!-- Rodapé -->
      <app-orders-sold-component></app-orders-sold-component>
    </div>
  `,
})
