// src/main/java/com/dianaglobal/paineldoauthor/adapter/out/mail/EmailChangeConfirmNewEmailService.java
...
public class EmailChangeConfirmNewEmailService {
    ...
    public void sendConfirmNew(String toEmail, String name, String confirmLink, int minutes) {
        final String subject = "Confirme seu novo e-mail";
    ...
    private String buildHtml(String name, String confirmLink, int minutes, String pageTitle) {
        ...
        return """
                      ...
                      <tr>
                        <td style="padding:24px;">
                          ...
                          <p style="font-size:14px;line-height:1.6;margin:0 0 16px;">
                            Recebemos uma solicitação para atualizar o e-mail da sua conta. Clique no botão abaixo para confirmar.
            ...
            """.formatted(
                pageTitle, brand,
                header("Confirme seu novo e-mail", safeLogo, brand),
                safeName, minutes,
                ctaButton(confirmLink, "Confirmar novo e-mail"),
                footer()
        );
    }
