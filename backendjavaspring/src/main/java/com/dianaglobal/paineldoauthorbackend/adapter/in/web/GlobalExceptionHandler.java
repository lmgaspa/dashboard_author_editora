// src/main/java/com/dianaglobal/paineldoauthor/adapter/in/web/GlobalExceptionHandler.java
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(com.dianaglobal.paineldoauthorbackend.application.service.exception.EmailUnconfirmedException.class)
    ...
    @ExceptionHandler(com.dianaglobal.paineldoauthorbackend.application.service.exception.TokenExpiredException.class)
    ...
    @ExceptionHandler(com.dianaglobal.paineldoauthorbackend.application.service.exception.TokenAlreadyUsedException.class)
