// src/main/java/com/dianaglobal/paineldoauthor/application/service/PasswordResetService.java
...
public class PasswordResetService {
    ...
    public void requestReset(String email, String frontendBaseUrl) {
        ...
        eventPublisher.publishAuthEvent("auth.password.reset", new AuthEmailEvent(
                "auth.password.reset", user.getName(), user.getEmail(), null, link, null, null));
    }
    ...
    public void resetPassword(String tokenPlain, String newPassword) {
        ...
        var entity = tokenRepo.findByTokenHashAndUsedAtIsNullAndExpiresAtAfter(tokenHash, Instant.now())
        ...
        try {
            ...
            eventPublisher.publishAuthEvent("auth.password.changed", new AuthEmailEvent(
                    "auth.password.changed", user.getName(), user.getEmail(), null, null, null, null));
        } catch (Exception e) {
