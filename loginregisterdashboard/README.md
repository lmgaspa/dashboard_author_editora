# 🔐 Dashboard Author Editora - Authentication & User Management System

Enterprise-grade authentication and user management platform with strict access control, built on Spring Boot and PostgreSQL.

## 🎯 What It Does

A comprehensive **authentication and authorization system** that provides secure user management with **admin-controlled registration**. Only administrators can create user accounts, ensuring complete control over system access. The platform supports multiple authentication methods, role-based access control, and a complete email notification system.
...
├── main/
│   ├── java/
│   │   └── com/dianaglobal/loginregisterdashboardeditora/
