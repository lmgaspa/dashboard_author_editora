...
import com.dianaglobal.loginregisterdashboardeditora.adapter.out.persistence.ConfirmResendThrottleRepository;
import com.dianaglobal.loginregisterdashboardeditora.adapter.out.persistence.entity.ConfirmResendThrottleEntity;
...
public class ConfirmationResendThrottleService {
    ...
    private String idFor(String userId, LocalDate day) { return userId + ":" + day; }

    public Info preview(String userId, Instant now) {
    ...
    public Info registerSend(String userId, Instant now, String emailHash) {
        var day = LocalDate.ofInstant(now, ZoneOffset.UTC);
        var id = idFor(userId, day);
