// src/main/java/com/dianaglobal/paineldoauthor/application/event/WelcomeEmailOnConfirm.java
package com.dianaglobal.paineldoauthorbackend.application.event;

import com.dianaglobal.paineldoauthorbackend.adapter.out.mail.WelcomeEmailService;
