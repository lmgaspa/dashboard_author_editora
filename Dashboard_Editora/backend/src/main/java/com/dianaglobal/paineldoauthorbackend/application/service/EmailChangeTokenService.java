...
public interface EmailChangeTokenService {
     ...
     * @throws com.dianaglobal.paineldoauthorbackend.application.service.exception.TokenExpiredException token expirado
     * @throws com.dianaglobal.paineldoauthorbackend.application.service.exception.TokenAlreadyUsedException token já usado/revogado
     */
