...
public class AccountConfirmationEmailService {
    ...
    public void send(String toEmail, String name, String confirmLink, int minutes) {
        final String subject = "Confirme seu e-mail";
    ...
    private String buildHtml(String name, String confirmLink, int minutes) {
        ...
        return """
            ...
            <head>
              ...
              <title>Confirme seu e-mail · %s</title>
              <style>
                img{display:block}
            ...
            <body style="margin:0;padding:24px;background:#f6f7f9;font-family:Arial,Helvetica,sans-serif;color:#111827;">
              ...
              <div style="display:none;visibility:hidden;opacity:0;color:transparent;height:0;width:0;overflow:hidden;mso-hide:all;">
                Confirme seu e-mail para finalizar a criação da sua conta.
              </div>
                      ...
                      <tr>
                        <td style="padding:24px;">
                          ...
                          <p style="font-size:14px;line-height:1.6;margin:0 0 16px;">
                            Obrigado por se cadastrar. Para finalizar a criação da sua conta, confirme seu endereço de e-mail.
                            Este link expira em <strong>%d minutos</strong>.
                          </p>
                          %s
                          <p style="font-size:12px;line-height:1.6;margin:16px 0 0;color:#374151;">
                            Se você não solicitou isso, ignore esta mensagem ou entre em contato com o suporte.
                          </p>
                        </td>
                      </tr>
                      %s
            ...
            """.formatted(
                brand,
                header("Confirme seu e-mail", logoUrl, brand),
                safeName, minutes,
                ctaButton(confirmLink, "Confirmar e-mail"),
                footer()
        );
    }
