...
public interface EmailChangeTokenService {
    ...
    record Payload(String userId, String newEmail) {}
     ...
     */
    String issue(String userId, String newEmailNormalized, Duration ttl);
     ...
     * @throws com.dianaglobal.loginregisterdashboardeditora.application.service.exception.TokenExpiredException token expirado
     * @throws com.dianaglobal.loginregisterdashboardeditora.application.service.exception.TokenAlreadyUsedException token já usado/revogado
     */
