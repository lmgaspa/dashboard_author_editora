// src/main/java/com/dianaglobal/paineldoauthor/adapter/out/mail/EmailChangeAlertOldEmailService.java
...
public class EmailChangeAlertOldEmailService {
    ...
    public void sendAlertOld(String oldEmail, String name, String supportUrl) {
        final String subject = "Alerta de segurança: alteração de e-mail detectada";
    ...
    private String buildHtml(String name, String supportUrl, String pageTitle) {
        ...
        return """
                      ...
                      <tr>
                        <td style="padding:24px;">
                          ...
                          <p style="font-size:14px;line-height:1.6;margin:0 0 16px;">
                            Recebemos uma solicitação para alterar o e-mail da sua conta. Se não foi você, entre em contato com o suporte imediatamente.
                          </p>
                          %s
                        </td>
                      </tr>
            ...
            """.formatted(
                pageTitle, brand,
                header("Alerta de segurança", safeLogo, brand),
                safeName,
                ctaButton(url, "Entrar em contato com suporte"),
                footer()
        );
    }
