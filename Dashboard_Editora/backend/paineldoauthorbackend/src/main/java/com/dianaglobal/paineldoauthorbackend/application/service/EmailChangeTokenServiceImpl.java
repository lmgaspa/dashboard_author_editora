// src/main/java/com/dianaglobal/paineldoauthor/application/service/EmailChangeTokenServiceImpl.java
...
import com.dianaglobal.paineldoauthorbackend.application.service.exception.TokenAlreadyUsedException;
import com.dianaglobal.paineldoauthorbackend.application.service.exception.TokenExpiredException;
...
public class EmailChangeTokenServiceImpl implements EmailChangeTokenService {
    ...
    @Override
    public String issue(String userId, String newEmailNormalized, Duration ttl) {
