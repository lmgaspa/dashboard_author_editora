      ...
      <div class="max-w-6xl mx-auto">
        <div class="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div class="flex flex-col md:flex-row items-center gap-3 md:gap-4">
            <div class="flex items-center gap-2">
              ...
              <a href="mailto:andescoresoftware@gmail.com" 
                 class="text-gray-300 text-sm hover:text-white transition-colors duration-200 font-medium">
          ...
          <div class="flex items-center gap-3">
            <!-- WhatsApp -->
            <a href="https://wa.me/5571994105740" 
               target="_blank" 
               rel="noopener noreferrer"
               class="w-10 h-10 flex items-center justify-center rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 hover:border-sky-400/50 transition-all duration-200 group"
               aria-label="WhatsApp"
               title="WhatsApp">
            ...
            <!-- GitHub -->
            <a href="https://github.com/lmgaspa" 
               target="_blank" 
               rel="noopener noreferrer"
               class="w-10 h-10 flex items-center justify-center rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 hover:border-sky-400/50 transition-all duration-200 group"
               aria-label="GitHub"
            ...
            <!-- LinkedIn -->
            <a href="https://www.linkedin.com/in/luiz-gasparetto-tech/" 
               target="_blank" 
               rel="noopener noreferrer"
               class="w-10 h-10 flex items-center justify-center rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 hover:border-sky-400/50 transition-all duration-200 group"
               aria-label="LinkedIn"
